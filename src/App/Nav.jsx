  ...
  return (
    <nav className=' p-5 shadow-md'>
        <div className="flex justify-between items-center">
            <div>
                <a href="/" className='text-xl text-indigo-600'>
                    LOGO
                </a>
            </div>
            ...
            <div className='md:hidden items-center'>
                <button id='menu-toggle' className='text-indigo-600 text-3xl pt-2' onClick={toggleMenu}>
            ...
            <ul className='hidden md:flex space-x-4 pr-5'>
                <li className='px-4'>
                    <a href="/" className='text-indigo-600 flex text-lg'>
        ...
        */}
        ...
        {menuopen ? (
                ...
                <li className='pb-2'>
                    <a href="/" className='text-indigo-600 flex text-xl pl-4 ease-in-out hover:translate-x-1 duration-300'>
                    <span className='pt-0.5 pr-2'><ion-icon name="home-outline"></ion-icon></span>Home
                    </a>
                </li>
                <li className='pb-2'>
                    <a href="/" className='text-indigo-600 flex ease-in-out hover:translate-x-1 duration-300'>
                    <span className='pt-0.5 pr-2'><ion-icon name="receipt-outline"></ion-icon></span>About
                    </a>
                </li>
                <li className='pb-2'>
